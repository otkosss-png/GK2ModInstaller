...
## 10. ?????????? ?? E2E (25.09): game-folder ???? ?????? ?????? ??????? ????

????????? ?? ????? `Recipe Pin` (3807460866):
- **????????? ?????????** game-folder ???? ?? ?????????? ???????? (?????? ??? ??? � ??????????? ??????);
- **??????????/???????? ??? ??????????????** � ???: `Managed\0Harmony.dll`, `GK2RecipePin.dll`, `GK2RecipePin.Core.dll` ???????? ????????? ??? ?? ????? ?????? ???? (`UnityEngine.CoreModule.dll`, ??? ? ?????? BepInEx). ????????? ????? ???? fail-closed (????? ????????), ?? ?????? ?? ???????????;
- **??? ?????**: ???? ?????? ???????, ? ??????????? ?? ???????, trust ??? ????? ?????????? ????? ??? ? ?????? ?? ?????????? (????? ????????? ??????? ???, ????? ????????? ?????? ????? ?????? `Update`).

**??????? (C):**
- **B** � DLL game-folder ???? **?? ??????????** ? ????? ????, ? ????????? ? ??????? ?? ?????? (`Assembly.Load(File.ReadAllBytes(...))`, `0Harmony` ??????? ?? `BepInEx\core`), ????? ??????????/????? ???????? ?? ?????; ?????????? ??-???????? ?????? **??-DLL** ????? (`Languages`, ??????) � ??? ?? ???????.
- **A** � ??, ??? ?????? ??????? ? ???? (???????? legacy-????? DLL ?? `Managed`), ????????? ????? ? `BepInEx\config\GK2_WorkshopLoader.pendinggame.txt`, ? `GK2 Mod Installer` ????????? ??? ??? ???????? ????.
- ????: ???????? ???? trust ??? ????????? ????????? (??. ????).

?????: ?? ??? ????? DLL ????? ????????? ??? `Managed` (????????? ?? ????? ?????); ? ???????????? ????????????? ???????? ?????? ????? ? `Managed` � ????? ??????? ???????? ????? A.
